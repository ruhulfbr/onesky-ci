...
//$tinybrowser['docroot'] = rtrim(preg_replace('/'.preg_quote(DIRECTORY_SEPARATOR).'js.*?$/i','',dirname(__FILE__)),'/');
...
if($_COOKIE['MUID']=='')
{
	...
	$tinybrowser['path']['image'] = '/staticpage/images/';// Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
	$tinybrowser['path']['media'] = '/staticpage/media/'; // Media files location
	$tinybrowser['path']['file']  = '/staticpage/files/'; // Other files location
}
else
{
	// File upload paths (set to absolute by default)
	$tinybrowser['path']['image'] = '/ccImage_'.$_COOKIE['MUID'].'/images/';// Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
	$tinybrowser['path']['media'] = '/staticpage/media/'; // Media files location
	$tinybrowser['path']['file']  = '/staticpage/files/'; // Other files location
}
//print_r($_COOKIE);
